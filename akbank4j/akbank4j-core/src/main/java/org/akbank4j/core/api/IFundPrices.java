 ...
 */
public interface IFundPrices {

  /**
   * Mevcut fon değerleri almak için izin verir.
   * <pre>{@code Akbank4J<FundPricesModel> findPrices = akbank.getFundPrices(AkbankParameters.FundPrices.TYPE_A);}</pre>
   * <pre>{@code Akbank4J<FundPricesModel> findPrices = akbank.getFundPrices(AkbankParameters.FundPrices.TYPE_B);}</pre>
   * <pre>{@code Akbank4J<FundPricesModel> findPrices = akbank.getFundPrices(AkbankParameters.FundPrices.ALL);}</pre>
   *
